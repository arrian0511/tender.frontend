...
import { ApiRequestParameter } from '../models/api-request-parameter';
...
export class ApiService {
   ...
   * @param {ApiRequestParameter} apiRequest
   * Api request consist of endpoint/url, data, headers, params, etc...
   */
  public get(apiRequest: ApiRequestParameter): Observable<Response> {
   ...
   * Api request consist of endpoint/url, data, headers, params, etc...
   */
  public post(apiRequest: ApiRequestParameter): Observable<Response> {
   ...
   * Api request consist of endpoint/url, data, headers, params, etc...
   */
  public patch(apiRequest: ApiRequestParameter): Observable<Response> {
   ...
   * Api request consist of endpoint/url, data, headers, params, etc...
   */
  public put(apiRequest: ApiRequestParameter): Observable<Response> {
   ...
   * Api request consist of endpoint/url, data, headers, params, etc...
   */
  public delete(apiRequest: ApiRequestParameter): Observable<Response> {
